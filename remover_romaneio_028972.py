...
# -*- coding: utf-8 -*-
"""
Script para remover o romaneio 028972 apenas das tabelas de SAÍDA
"""
...
def remover_romaneio_saida(conn, romaneio: str):
    """Remove o romaneio apenas das tabelas de SAÍDA"""
    cursor = conn.cursor()
    conn.autocommit = False
    
    try:
        print(f"\n🔍 Removendo romaneio {romaneio} das tabelas de SAÍDA...")
        ...
        conn.commit()
        print(f"\n✅ Romaneio {romaneio} removido com sucesso das tabelas de SAÍDA!")
...
def main():
    ...
    print("=" * 100)
    print("REMOVER ROMANEIO 028972 - APENAS TABELAS DE SAÍDA")
    print("=" * 100)
    print(f"\n⚠️  ATENÇÃO: Removendo o romaneio {romaneio} apenas das tabelas de SAÍDA!")
    print(f"   - ESTOQUE_PROD1_SAI")
    print(f"   - ESTOQUE_PROD_SAI")
    print(f"   - LOJA_SAIDAS_PRODUTO")
    print(f"   - LOJA_SAIDAS")
    print(f"\n   ⚠️  NÃO será removido de:")
    print(f"   - ESTOQUE_PROD_ENT")
    print(f"   - ESTOQUE_PROD1_ENT")
    print(f"   - LOJA_ENTRADAS")
    print(f"   - LOJA_ENTRADAS_PRODUTO")
    ...
    try:
        remover_romaneio_saida(conn, romaneio)
    except Exception as e:
        print(f"\n❌ Erro: {e}")
    finally:
        conn.close()
