...
async function executeTransfer(pool, params) {
  ...
  req0.input('filialOrigem', sql.VarChar, filialOrigem);
  req0.input('filialDestino', sql.VarChar, filialDestino);
  ...
  if (resultNomesFiliais.recordset.length === 0) {
    ...
    req0b.input('filialOrigem', sql.VarChar, filialOrigem);
    req0b.input('filialDestino', sql.VarChar, filialDestino);
  ...
  while (tentativas < 10) {
    ...
    reqVerificar.input('filialOrigemNome', sql.VarChar, filialOrigemNome);
  ...
  reqValida.input('filialOrigemNome', sql.VarChar, filialOrigemNome);
  ...
  req2.input('filialOrigemCod', sql.VarChar, filialOrigemCod);
  req2.input('filialDestinoCod', sql.VarChar, filialDestinoCod);
  ...
  if (empresaOrigem === null) {
    ...
    reqEmp.input('filialOrigemCod', sql.VarChar, filialOrigemCod);
  ...
  if (empresaDestino === null) {
    const reqEmp = pool.request();
    reqEmp.input('filialDestinoCod', sql.VarChar, filialDestinoCod);
