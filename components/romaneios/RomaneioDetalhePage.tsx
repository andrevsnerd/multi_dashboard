...
import { planejarItensAgrupados } from "@/lib/utils/romaneio-agrupamento";
...
export default function RomaneioDetalhePage({
  ...
  // Regra compartilhada com a tela Defeitos (ver lib/utils/romaneio-agrupamento).
  const itensPlanejados = planejarItensAgrupados(itensFiltrados, companySlug);
